...
export class SecureLoggerCordovaInterface {
     ...
     * default = 250
     */
    get flushIntervalDelayMs() {
        return this.mFlushIntervalDelayMs;
    }
    set flushIntervalDelayMs(value) {
        if (typeof value === 'number') {
     ...
     */
    setEventCacheFlushInterval(intervalMs) {
    ...
    prependQueuedEvents(events) {
        this.mEventCache.unshift(...events);
        this.purgeExcessEvents();
    }
    onFlushCaptureFailure(error, events) {
        var _a;
        ...
        this.error(PLUGIN_NAME, `failed to capture ${(_a = events === null || events === void 0 ? void 0 : events.length) !== null && _a !== void 0 ? _a : -1} events! (error was: ${error})`);
    }
}
/**
